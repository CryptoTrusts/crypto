				...
				<div class="form-container">
					<div>
						...
						<div class="row text-center">
							<h3 class="title-head" style="font-size:1.5em; color:#555;">User Registration</h3>
						</div>
						<!-- Section Title Ends -->
						<!-- Form Starts -->
                        ...
                        <!-- Input Field Starts -->
 						...
 						<div class="g-recaptcha" data-sitekey="6LeKrJ4UAAAAAD9sOn88X99mOOLWsZnXM1qeKiL9"></div>
						 <br/>
							<!-- Input Field Ends -->
                            <!-- Input Field Starts -->
							...
							<!-- Input Field Ends -->
							 ...
							 <div class="form-group">
								...
								I have read and agreed to the <a href="{{ route('terms') }}">Terms of Service</a> 
                            </div>
							<!-- Input Field Ends -->
